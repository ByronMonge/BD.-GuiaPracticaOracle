...
public class Validaciones {
    ...
    public boolean validarTextoSinEspacio(String texto) {
        ...
        if (texto.isEmpty()) {
            ...
            if (texto.charAt(0) >= 65 && texto.charAt(0) <= 90 && texto.length() >= 3 && texto.length() <= 20 || texto.charAt(0) == 209 || texto.charAt(0) == 193 || texto.charAt(0) == 201 || texto.charAt(0) == 205 || texto.charAt(0) == 211 || texto.charAt(0) == 218) {//Valido que la primera letra del texto sea mayuscula y el texto tenga mas de 3 letras(Tambien acepta vocales mayusculas con tilde)
